 ...
 * 
 * <p>For an {@link Enum}, the enum values represents the universe. It is 
 ...
 * <p>The {@link IndexedUniverse} is based on the same principle, but for 
 ...
 * is {@code null}.</p>
 * <p>The number of elements in the universe is returned by {@link #size()}.
 * </p>
 * <p>Though every element in the universe has to correspond to an index, 
 ...
 * number of elements, there are unmapped indexes.</p>
 *       
